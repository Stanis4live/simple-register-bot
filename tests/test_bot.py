...
from bot import start, accept_agreement, Registration, get_phone_number, finish_registration, bot
...
class BotTests(TestCase):
    ...
    def test_get_phone_number(self):
        ...
        Проверяет, что после отправки номера телефона пользователю предлагается ввести своё имя.'''
        ...
        mock_message.answer.assert_called_once_with("Пожалуйста, введите ваше имя.")
